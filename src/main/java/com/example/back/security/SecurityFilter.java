...
import static com.example.back.utils.Constants.HEADER_AUTHORIZATION;
import static com.example.back.utils.Constants.SPACE_SEPARATOR;
...
public class SecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (authorizationHeader != null && authorizationHeader.split(SPACE_SEPARATOR).length == 2) {
            ...
            decodeTokenAndPopulateUser(token, issuerUri);
